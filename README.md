...
- 🔴 Pembuatan skill baru khusus untuk *live streaming* dan integrasi OBS ke YouTube yang dikontrol penuh melalui Bot Telegram. (Saat ini belum tersedia).
...
├── skills/                        # Modul Skill (YouTube: upload, edit, auth)
├── interfaces/                    # (Future) Interfaces seperti Telegram
